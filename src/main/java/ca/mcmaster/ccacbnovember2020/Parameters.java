...
public class Parameters {
    ...
    public static final String PRESOLVED_MIP_FILENAME = "F:\\temporary files here recovered\\seymour-disj-10.pre.sav";  
    ...
    public static final int HUGE_WORKMEM =(HUNDRED +92)*THOUSAND ;
    ...
    public static List<String> mipsWithBarrier = new ArrayList<String> (
        Arrays.asList( "seymour-disj-10.pre", "supportcase3.pre", "huahum.pre.sav"));
